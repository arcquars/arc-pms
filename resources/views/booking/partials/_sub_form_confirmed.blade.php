...
<div class="row">
    <div class="col-md-6 form-group">
        <label for="c-cost-discount">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input"  type="radio" name="cost[discount_type]"
                       ...
                       onchange="showTypeDiscount(this)" disabled
                />
        ...
        <div class="input-group input-group-sm c-section-discount">
            ...
            <select name="cost[discount]" id="c-cost-discount" class="form-control" onchange="calculateCost();" disabled>
            ...
            @else
                ...
                <input type="number" name="cost[discount]" id="e-cost-discount" class="form-control form-control-sm"
                       onchange="calculateCostEdit();" value="{{$booking->discount}}" disabled
                />
            @endif
    ...
    <div class="col-md-6 form-group">
        ...
        <div class="input-group input-group-sm">
            ...
            <input type="text" class="form-control form-control-sm" id="c-cost-extra_charge" name="cost[extra_charge]"
                   onchange="calculateCost();" disabled
...
<div class="row">
    <div class="col-md-6 form-group">
        ...
        <div class="input-group input-group-sm">
            ...
            <input type="text" class="form-control form-control-sm" id="c-cost-forward" name="cost[forward]"
                   value="{{ $booking->forward }}" onchange="calculateCost()" disabled
            />
        </div>
        <div class="invalid-feedback"></div>
    </div>
    <div id="cGroupForwardMethodPayment" class=" col-md-6 form-group">
        ...
        <select name="booking[forward_method_payment]" id="c-booking-forward_method_payment" class="form-control form-control-sm" disabled>
            <option value="">Seleccione...</option>
...
<div class="form-group">
    ...
    <textarea class="form-control form-control-sm" id="c-booking-comments" name="booking[comments]" disabled >{{ $booking->comments }}</textarea>
    <div class="invalid-feedback"></div>
</div>
