                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <form method="post" action="{{route('roomlevel.update', $roomlevel->id)}}">
                                    @method('put')
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="frl-detail" name="detail" class="form-control @error('detail') is-invalid @enderror">{{@old('detail', $roomlevel->detail)}}</textarea>
                                            @error('detail')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <input type="submit" class="btn btn-primary" value="{{ __('hotel-manager.update') }}" />
