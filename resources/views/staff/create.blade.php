                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">{{ __('hotel-manager.add_staff') }}
                                ...
                                <form enctype="multipart/form-data" method="post" action="{{url('admin/staff')}}">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="radio" name="salary_type" value="daily"> {{ __('hotel-manager.daily') }}
                                                <input type="radio" name="salary_type" value="monthly"> {{ __('hotel-manager.monthly') }}
                                            </td>
                                        </tr>
                                        <tr>
