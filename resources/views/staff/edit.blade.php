                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">{{ __('hotel-manager.update_staff') }}
                            ...
                            <div class="table-responsive">
                                <form enctype="multipart/form-data" method="post" action="{{url('admin/staff/'.$data->id)}}">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th>{{ __('hotel-manager.select_department') }}</th>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input @if($data->salary_type=='daily') checked @endif type="radio" name="salary_type" value="daily"> {{ __('hotel-manager.daily') }}
                                                <input @if($data->salary_type=='monthly') checked @endif type="radio" name="salary_type" value="monthly"> {{ __('hotel-manager.monthly') }}
                                            </td>
                                        </tr>
                                        <tr>
